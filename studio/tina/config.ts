    ...
    templates: [
      ...
      },
      {
        ...
        fields: [
          ...
          { type: "string", name: "bio", label: "Bio", ui: { component: "richtext" } },
    ...
    templates: [
      ...
      },
      {
        ...
        fields: [
          ...
          { type: "string", name: "body", label: "Bio Override", ui: { component: "richtext" } },
      ...
      },
      {
        ...
        fields: [{ type: "boolean", name: "enabled", label: "Enabled" },
          ...
          { type: "string", name: "title", label: "Title Override" },
          {
            ...
            fields: [
              { type: "string", name: "title", label: "Title" },
              { type: "string", name: "description", label: "Description", ui: { component: "richtext" } },
              { type: "string", name: "icon", label: "Icon", options: iconOptions },
            ],
          },
        ...
        fields: [{ type: "boolean", name: "enabled", label: "Enabled" },
          ...
          { type: "string", name: "title", label: "Title Override" },
          {
            ...
            fields: [
              ...
              { type: "string", name: "answer", label: "Answer", ui: { component: "richtext" } },
            ],
          },
          variantField("faq"),
          tenantImageField("backgroundImage", "Background Image", "Optional background image for this section") as TinaField,
      ...
      },
      {
        ...
        fields: [{ type: "boolean", name: "enabled", label: "Enabled" },
          { type: "string", name: "title", label: "Title Override" },
          { type: "string", name: "body", label: "Body Override", ui: { component: "richtext" } },
          {
            type: "object",
            name: "buttons",
            label: "Buttons",
      ...
      },
      {
        ...
        fields: [{ type: "boolean", name: "enabled", label: "Enabled" },
          ...
          { type: "string", name: "body", label: "Body", ui: { component: "richtext" } },
          variantField("text"),
          tenantImageField("backgroundImage", "Background Image", "Optional background image for this section") as TinaField,
          { type: "string", name: "css", label: "CSS Overrides", ui: { component: "css" } },
        ],
