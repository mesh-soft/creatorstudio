          ...
          <div style={{display:"flex",alignItems:"center",gap:4,flexShrink:0}}>
            ...
            {onOpenHistory && (
              <button onClick={onOpenHistory} style={{
                ...hdrBtn(T),
                borderColor: snapshotPage ? T.accent : undefined,
                background:  snapshotPage ? `${T.accent}22` : undefined,
                color:       snapshotPage ? T.accent : undefined,
              }}>
            ...
            <button
              ...
              onMouseLeave={e=>{(e.currentTarget as HTMLButtonElement).style.borderColor=T.isDark?T.borderMd:"#C8CBD0";(e.currentTarget as HTMLButtonElement).style.color=T.textSub;}}
            >
              Sign out
            </button>
          </div>
  ...
  return (
    <>
      ...
      <div style={{
        ...
        {/* Section tabs — Heroku underline style */}
        <div style={{display:"flex",borderBottom:`1px solid ${T.borderMd}`,padding:"0 18px",flexShrink:0,background:T.surface,overflowX:"auto"}}>
          {SITE_SECTIONS.map(s=>(
