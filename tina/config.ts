...
const pageContentFields: TinaField[] = [
...
const pageFields: TinaField[] = [
  ...
  { type: "boolean", name: "isHome", label: "Is Home Page" },
  {
    ...
    description: "Leave empty to use site-level presentation settings",
    fields: [
      {
        type: "string",
        name: "themeId",
  ...
  },
  {
    ...
    description: "Leave empty to use site-level SEO settings",
    fields: [
      { type: "string", name: "title", label: "Title" },
      { type: "string", name: "description", label: "Description", ui: { component: "textarea" } },
      { type: "string", name: "keywords", label: "Keywords", list: true },
